...
Next: scan frontend (Vue components, TypeScript) for unused imports or dead components. Also check for unused npm dependencies not caught by earlier iterations (e.g. @vueuse/core, @vueuse/integrations — are integration adapters unused?).
