...
## State
375px overflow fixed: stats row was 442px inside a 343px container (Restaurants/Cities clipped); now px-3/gap-1.5/text-2xl on mobile → 315px, fits; sm: keeps dramatic desktop (573px). Measured live via Playwright both viewports; 1095 vitest + vue-tsc green.
