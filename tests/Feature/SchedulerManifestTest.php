...
class SchedulerManifestTest extends TestCase
{
    ...
    private const EXPECTED_SCHEDULE = [
        ...
        'restaurants:photo-thumbnails --apply --limit=1000' => '15 14 * * *',
        'restaurants:photo-thumbnails --prune --apply' => '30 15 * * 4',
        'restaurants:seed-places --apply --limit=25 --min-rows=5' => '45 14 * * *',
        'restaurants:backfill-photos --verify --apply --limit=1000' => '30 12 * * 3',
